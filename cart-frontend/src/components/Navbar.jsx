  ...
  return (
    <div>
      <nav className="bg-slate-900 mr-3 h-16 mx-auto p-5 flex justify-between items-center border-b-4 w-full fixed top-0 z-30">
        <Link to={"/"}>
          <h2 className='font-semibold text-white text-3xl ml-7 hover:text-cyan-200'>Cafe Moto</h2>
        </Link>

        <div className="flex justify-center items-center gap-5">
          <Link to={"/admin"}>
            <p className="text-white text-lg hover:text-cyan-200">Admin</p>
          </Link>

          <Link to={"/cart"}>
            <div className="flex text-white relative pr-7 hover:text-cyan-200">
